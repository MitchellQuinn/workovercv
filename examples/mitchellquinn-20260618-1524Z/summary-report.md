...
- Repositories reviewed: 4 (claimlint, bounded-monocular-perception, industrial-sound-anomaly-detection, workovercv)
...
Representative evidence paths include `mitchellquinn-claimlint/README.md`, `mitchellquinn-claimlint/docs/adapter_contract.md`, `mitchellquinn-claimlint/docs/architecture.md`. Use the evidence gaps below to clarify what the public corpus cannot show.
...
- Weaker confidence areas: Signals are drawn from 4 repository record(s); cross-repository confidence depends on how many repositories contain matching artifact types.
