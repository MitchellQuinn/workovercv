...
- Repositories reviewed: 5 (agent-working-ledger, workovercv, skilldoctor, claimlint, bounded-monocular-perception)
...
Representative evidence paths include `mitchellquinn-agent-working-ledger/README.md`, `mitchellquinn-workovercv/docs/adapter_contract.md`, `mitchellquinn-skilldoctor/docs/architecture.md`. Use the evidence gaps below to clarify what the public corpus cannot show.
...
- Confidence: high
- Example evidence paths: `mitchellquinn-agent-working-ledger/README.md`; `mitchellquinn-workovercv/docs/adapter_contract.md`
...
- Confidence: high
- Example evidence paths: `mitchellquinn-agent-working-ledger/pyproject.toml`; `mitchellquinn-bounded-monocular-perception/02_synthetic-data-processing-v4.0/rb_pipeline_v4/config.py`
