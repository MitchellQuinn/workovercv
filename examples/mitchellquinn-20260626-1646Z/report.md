...
Repository names: agent-working-ledger, workovercv, skilldoctor, claimlint, bounded-monocular-perception
...
| ----------- | ---------- | ---- | ------------- | -------------- |
| ev-001-documentation-reviewer-context-01 | mitchellquinn-agent-working-ledger | README.md | README | Selected because it exposes reviewer-facing purpose, setup, boundaries, or usage context. |
...
| ev-005-evaluation-measurement-artifacts-05 | mitchellquinn-workovercv | examples/mitchellquinn-20260625-1127Z/run_manifest.json | run_manifest | Selected because it exposes measurement, benchmark, model, data, or run context. |
...
| Evidence ID | Repository | Path | Artifact type | Why it matters |
| ----------- | ---------- | ---- | ------------- | -------------- |
| ev-006-maintainability-project-structure-01 | mitchellquinn-agent-working-ledger | pyproject.toml | configuration_file | Selected because it helps reviewers inspect project structure, setup, or modification boundaries. |
...
| Evidence ID | Repository | Path | Artifact type | Why it matters |
| ----------- | ---------- | ---- | ------------- | -------------- |
| ev-008-product-reviewer-positioning-01 | mitchellquinn-agent-working-ledger | README.md | README | Selected because it packages the work for technical readers, users, or adapter reviewers. |
...
| ev-008-product-reviewer-positioning-04 | mitchellquinn-skilldoctor | README.md | README | Selected because it packages the work for technical readers, users, or adapter reviewers. |
| ev-008-product-reviewer-positioning-05 | mitchellquinn-claimlint | README.md | README | Selected because it packages the work for technical readers, users, or adapter reviewers. |
