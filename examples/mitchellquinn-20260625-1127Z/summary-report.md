...
- Repositories reviewed: 5 (skilldoctor, workovercv, claimlint, bounded-monocular-perception, industrial-sound-anomaly-detection)
...
Representative evidence paths include `mitchellquinn-skilldoctor/README.md`, `mitchellquinn-workovercv/docs/adapter_contract.md`, `mitchellquinn-skilldoctor/docs/architecture.md`. Use the evidence gaps below to clarify what the public corpus cannot show.
...
- Confidence: high
- Example evidence paths: `mitchellquinn-skilldoctor/README.md`; `mitchellquinn-workovercv/docs/adapter_contract.md`
...
- Confidence: high
- Example evidence paths: `mitchellquinn-skilldoctor/pyproject.toml`; `mitchellquinn-bounded-monocular-perception/02_synthetic-data-processing-v4.0/rb_pipeline_v4/config.py`
